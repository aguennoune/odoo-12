...
sudo sysctl -p
sed -i 's/10012/'$PORT'/g' $DESTINATION/docker-compose.two.yml
sed -i 's/20012/'$CHAT'/g' $DESTINATION/docker-compose.two.yml
# run Odoo
docker-compose -f $DESTINATION/docker-compose.two.yml up -d
